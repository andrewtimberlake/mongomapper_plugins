...
module MongoMapper
  module Plugins
    describe VersionedUpdate do
      ...
      context "without versioned_update loaded" do
        it "should not have a _version key" do
          model_class.keys.should_not include('_version')
        end
      end

      context "with versioned_update loaded" do
        before do
